...
public class DataLoader {
	...
	private void loadData(){
		...
		// create an author
		Author dv = new Author("Dan","Vega","dan@gmail.com");
	...
	private void createAuthors() {
		Author jv = new Author("Joe","Vega","jvega@gmail.com");
		authorRepository.save(jv);
		Author av = new Author("Andy","Vega","avega@gmail.com");
		authorRepository.save(av);
		Author kv = new Author("Katie","Vega","kvega@gmail.com");
